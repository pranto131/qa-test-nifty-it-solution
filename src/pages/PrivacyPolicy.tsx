...
import { Shield, Lock, Eye, FileText, Users, Globe, CheckCircle2, AlertCircle } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto py-20 px-4">
          <div className="flex items-center justify-center min-h-[400px]">
            <div className="text-center">
              ...
              <p className="text-lg text-muted-foreground mt-4">Loading privacy policy...</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none prose-headings:scroll-mt-20">
            <ReactMarkdown
              components={{
                ...
                h2: ({ node, ...props }) => {
                  const icons: { [key: string]: typeof Shield } = {
                    'Information We Collect': Eye,
                    'How We Use': Globe,
                    'Data Storage': Lock,
                    'Your Rights': CheckCircle2,
                    'Contact': Users,
                  };
